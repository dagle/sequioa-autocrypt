...
use crate::acs::{canonicalize, peer::Prefer, sqlite::SqliteDriver, store::AutocryptStore};
...
fn parsed_email(ac: &AutocryptStore<SqliteDriver>) -> Result<()> {
...
pub fn decrypt(ac: &AutocryptStore<SqliteDriver>, policy: &dyn Policy) -> Result<()> {
...
fn main() -> Result<()> {
    ...
    let ac = AutocryptStore::new(sqlite, Some("hunter2"), false)?;
